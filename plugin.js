...
// Porting BY EMI INDO with c3addon-ide-plus
{
    ...
    const PLUGIN_ID = "EMI_INDO_CheckInternetAccess";
    // callMap Deprecated const PLUGIN_VERSION = "1.0.0.0";
    const PLUGIN_CATEGORY = "web";

    const PLUGIN_CLASS = SDK.Plugins.EMI_INDO_CheckInternetAccess = class CheckInternetAccessPlugin extends SDK.IPluginBase {
        constructor() {
            super(PLUGIN_ID);
